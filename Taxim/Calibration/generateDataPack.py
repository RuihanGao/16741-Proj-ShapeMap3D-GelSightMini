...
parser.add_argument("--imgw", type=int, default=320, help="image width")
parser.add_argument("--imgh", type=int, default=240, help="image height")

args = parser.parse_args()
w, h = args.imgw, args.imgh # was 640, 480 in the original implementation

class Circle:
  """the circle drawed on the tactile image to get the contact size"""
  color_circle = (0, 128, 0)
  opacity = 0.5
  def __init__(self, w, h, radius=25, increments=2):
    self.center = [h/2,w/2]
    self.radius = radius
