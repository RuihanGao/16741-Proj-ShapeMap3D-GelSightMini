...
#         print(pred_depth_image.shape)
        np.save('../outputs/test/gt/Test_gt_depth_{:05d}.npy'.format(idx), input_gt_depth_image)
        np.save('../outputs/test/pred/Test_pred_depth_{:05d}.npy'.format(idx), pred_depth_image)
